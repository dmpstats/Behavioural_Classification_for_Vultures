...
rFunction_nonconv_ns = function(data, 
                     travelcut = 3,
                     altbound = 25,
                     sunrise_leeway = 0,
                     sunset_leeway = 0,
...
speed_time_model_nonconv_ns <- function(dt, 
                             pb = NULL, 
                             diag_plots = TRUE, 
                             in_parallel = TRUE, 
  ...
  if(n_days < 10){
    ...
    # stderr > estimates fails, invalidate speed-time classification
